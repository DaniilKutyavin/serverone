...
class GiftService {
    async createGift(data, img1, img2, img3) {
        const { description, nameOne, priceOne, nameTwo, priceTwo, nameThree, priceThree } = data;
    ...
    img3.mv(path.resolve(__dirname, '..', 'static', imgFileName3));
        ...
        const gift = await Gift.create({  description, nameOne, priceOne,nameTwo,priceTwo,nameThree, priceThree,  imgOne: imgFileName1, 
            imgTwo: imgFileName2, 
